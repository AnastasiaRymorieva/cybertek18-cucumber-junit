...
# Note: Follow POM, and solution should be done using Cucumber parameterizatio

Feature: SmartBear order process
  @smartBearWip
  Scenario: User verifies order process
    Given User is on SmartBear
